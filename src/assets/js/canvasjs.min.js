...
(function () {
  ...
  var Ga = !1,
    ...
    Ea = t ? "Impact, Charcoal, sans-serif" : "Arial",
    za = {
  ...
  W.prototype.updateOption = function (k) {
    ...
    var l = qa[this._defaultsKey],
      ...
      I = this._index;
    this.theme && s(this.parent) && s(E) && s(I)
      ...
      : this.parent &&
        ...
        (null === I
          ...
          : 0 < this.parent.themeOptions[E].length &&
            ((t = Math.min(this.parent.themeOptions[E].length - 1, I)),
  ...
  ya.prototype.setLayout = function () {
    if (this.text) {
      ...
      s(this.padding) || "number" !== typeof this.padding
        ...
        : (M = 2.5 * this.padding);
      this.wrap ||
        (I = Math.min(I, Math.max(1.5 * this.fontSize, this.fontSize + M)));
      I = new la(this.ctx, {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((w = l.y2 - 2 - M.height), (G = "bottom")),
          "left" === this.horizontalAlign
            ? (t = l.x1 + 2)
            : "center" === this.horizontalAlign
            ? (t = l.x1 + l.width / 2 - M.width / 2)
            : "right" === this.horizontalAlign && (t = l.x2 - 2 - M.width - D),
  ...
  Ka.Chart = (function () {
    ...
    l.prototype.renderElements = function () {
      ...
      if (0 < c.length)
          ...
          r._animator.animate(
            ...
            function (a) {
              ...
              r.ctx.drawImage(
                ...
                0,
                0,
                Math.floor(r.width * ja),
                Math.floor(r.height * ja),
                0,
                0,
                r.width,
                r.height
        ...
        if (r._breaksCanvas)
          ...
          else for (g = 0; g < r._axes.length; g++) r._axes[g].createMask();
      ...
      for (g = 0; g < this._axes.length; g++)
        this._axes[g].maskCanvas &&
          (delete this._axes[g].maskCanvas, delete this._axes[g].maskCtx);
    };
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          ...
          if ("normal" === g.axisPlacement || "xySwapped" === g.axisPlacement)
            var l = a.axisX.sessionVariables.newViewportMinimum
              ...
              u = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (g.dataPoints[r].x && g.dataPoints[r].x.getTime) ||
          ...
          for (r = 0; r < g.dataPoints.length; r++) {
            ...
            g.dataPoints[r].x.getTime
              ? ((m = !0), (b = g.dataPoints[r].x.getTime()))
              : (b = g.dataPoints[r].x);
            ...
            0 < r &&
              ...
              e &&
                null !== e[0] &&
                g.dataPoints[r - 1].y &&
                null !== g.dataPoints[r - 1].y[0] &&
                (a.axisY.logarithmic
                  ? ((C = e[0] / g.dataPoints[r - 1].y[0]),
                    1 > C && (C = 1 / C),
                    d.minDiff > C && 1 !== C && (d.minDiff = C))
                  : ((C = e[0] - g.dataPoints[r - 1].y[0]),
                    0 > C && (C *= -1),
            ...
            if (!(b < l) || q) {
              ...
              g.dataPoints[r].label &&
                (a.axisX.labels[b] = g.dataPoints[r].label);
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
            ...
            if (!(4 > m.dataPoints.length))
              for (g = 0; g < m.dataPoints.length; g++)
                (h =
                  ...
                  100),
                  (b = m.dataPoints[g].x.getTime
                    ? m.dataPoints[g].x.getTime()
                    : m.dataPoints[g].x),
                  (h = Math.floor((b - c) / h)),
                  b < f[h].min && (f[h].min = b),
                  b > f[h].max && (f[h].max = b);
    ...
    l.prototype.validateRegion = function (a, d, c, b, e) {
      ...
      for (n = 0; n < g.length; n++) {
        var q = g[n],
          ...
          h = q.convertPixelToValue({ x: c, y: b });
        if (p > h)
          var C = h,
            h = p,
            p = C;
        if (q.scaleBreaks)
          for (C = 0; !f && C < q.scaleBreaks._appliedBreaks.length; C++)
            f =
              ...
              q.scaleBreaks._appliedBreaks[C].endValue >= h;
        if (isFinite(q.dataInfo.minDiff))
          if (
            ((C = q.getApparentDifference(p, h, null, !0)),
            !(
              f ||
              (!(
                this.panEnabled &&
            ...
            A.push(q), r.push({ val1: p, val2: h }), (m = !0);
          else if (!e) {
            m = !1;
            break;
          }
    ...
    l.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var g = this._indexLabels[a],
          ...
          q,
          p,
          m = ma("indexLabelFontColor", g.dataPoint, g.dataSeries),
        ...
        var n = ma("indexLabelFontWeight", g.dataPoint, g.dataSeries),
          ...
          l = s(g.dataPoint.indexLabelLineThickness)
            ? s(g.dataSeries.options.indexLabelLineThickness)
              ? 0
              : g.dataSeries.options.indexLabelLineThickness
          ...
          x = null;
        if (
          0 <= g.dataSeries.type.indexOf("stacked") ||
          "pie" === g.dataSeries.type ||
          "doughnut" === g.dataSeries.type
        )
        ...
        var z = g.dataPoint.indexLabelFormatter
          ? g.dataPoint.indexLabelFormatter(x)
          : g.dataPoint.indexLabel
          ...
          : g.dataSeries.indexLabelFormatter
          ? g.dataSeries.indexLabelFormatter(x)
          : g.dataSeries.indexLabel
          ? this.replaceKeywordsWithValue(
              g.dataSeries.indexLabel,
              g.dataPoint,
              g.dataSeries,
        ...
        if (null !== z && "" !== z) {
          ...
          if ("stackedarea100" === r) {
            ...
            if (
              g.dataPoint.x < y.viewportMinimum ||
              g.dataPoint.x > y.viewportMaximum ||
              Math.max.apply(null, g.dataPoint.y) < B.viewportMinimum ||
              Math.min.apply(null, g.dataPoint.y) > B.viewportMaximum
            )
              continue;
          } else if (
            0 <= r.indexOf("line") ||
            ...
            if (
              g.dataPoint.x < y.viewportMinimum ||
              g.dataPoint.x > y.viewportMaximum ||
              g.dataPoint.y < B.viewportMinimum ||
              g.dataPoint.y > B.viewportMaximum
            )
              continue;
          } else if (
            0 <= r.indexOf("column") ||
          ...
          e = n = 2;
          "horizontal" === x
            ? ((m = h.width), (A = h.height))
            : ((A = h.width), (m = h.height));
                ...
                0 < J
                  ...
                  : ((p = g.point.y + n + b),
                    p > f - A - n - b &&
                      ((p =
                        "auto" === u
                          ? Math.min(g.point.y, f) - A - n - b
                          : f - A - n - b),
                      (v = p < g.point.y))))
              : ((e = Math.max(g.bounds.y1, c.y1)),
                (f = Math.min(g.bounds.y2, c.y2)),
                (b =
                  0 <= r.indexOf("range") || "error" === r
                    ? 0 < J
                      ? Math.max(g.bounds.y1, c.y1) + A / 2 + n
                      : Math.min(g.bounds.y2, c.y2) - A / 2 - n
                    : (Math.max(g.bounds.y1, c.y1) +
                        Math.min(g.bounds.y2, c.y2)) /
                      2),
                0 < J
                  ? ((p = Math.max(g.point.y, b) - A / 2),
                    p < e &&
                      ("bubble" === r || "scatter" === r) &&
                      (p = Math.max(g.point.y - A - n, c.y1 + n)))
                  : ((p = Math.min(g.point.y, b) - A / 2),
                    p > f - A - n &&
                      ("bubble" === r || "scatter" === r) &&
                      (p = Math.min(g.point.y + n, c.y2 - A - n))),
                (p = Math.min(p, f - A)));
          } else
            0 <= r.indexOf("line") ||
            0 <= r.indexOf("area") ||
                  ...
                  0 > J
                    ...
                    : ((q = g.point.x + e + b),
                      q > f - m - e - b &&
                        ((q =
                          "auto" === u
                            ? Math.min(g.point.x, f) - m - e - b
                            : f - m - e - b),
                        (v = q < g.point.x))))
                : ((n = Math.max(g.bounds.x1, c.x1)),
                  Math.min(g.bounds.x2, c.x2),
                  (b =
                    0 <= r.indexOf("range") || "error" === r
                      ? 0 > J
                        ? Math.max(g.bounds.x1, c.x1) + m / 2 + e
                        : Math.min(g.bounds.x2, c.x2) - m / 2 - e
                      : (Math.max(g.bounds.x1, c.x1) +
                          Math.min(g.bounds.x2, c.x2)) /
                        2),
                  (q =
                    0 > J
                      ? Math.max(g.point.x, b) - m / 2
                      : Math.min(g.point.x, b) - m / 2),
                  (q = Math.max(q, n)));
          "vertical" === x && (p += A);
          h.x = q;
          h.y = p;
          ...
          l &&
            ...
            0 <= r.indexOf("bar") || ("error" === r && g.axisSwapped)
              ? d.lineTo(
                  q + (0 < g.direction ? 0 : m),
                  p + ("horizontal" === x ? A : -A) / 2
                )
              : 0 <= r.indexOf("column") || ("error" === r && !g.axisSwapped)
              ? d.lineTo(
                  q + m / 2,
                  p +
                    ((0 < g.direction ? A : -A) +
              ...
              : d.lineTo(
                  q + m / 2,
                  p +
                    ((p < g.point.y ? A : -A) + ("horizontal" === x ? A : -A)) /
                      2
                ),
            d.stroke());
        }
      ...
      for (a = 0; a < this._indexLabels.length; a++)
        (g = this._indexLabels[a]),
          (h = ma("indexLabelBackgroundColor", g.dataPoint, g.dataSeries)),
          (g.dataSeries.indexLabelBackgroundColor = s(h)
            ? t
              ? "transparent"
              : null
            : h);
    ...
    l.prototype.renderLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], n, m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          var C = g._colorSet,
            k = (C = g.lineColor = g.options.lineColor
              ? g.options.lineColor
              : C[0]);
          c.strokeStyle = C;
          var l = !0,
            ...
            for (var J = !1, u = 0; u < r.length; u++)
              if (
                ...
                if ("number" !== typeof r[u].y)
                  ...
                  u < r.length - 1 &&
                    (k !== (r[u].lineColor || C) ||
                      q !== (r[u].lineDashType || g.lineDashType)) &&
                    (c.stroke(),
                    c.beginPath(),
                    c.moveTo(x, s),
                    (k = r[u].lineColor || C),
                    ...
                    c.setLineDash &&
                      (r[u].lineDashType
                        ? ((q = r[u].lineDashType),
                          c.setLineDash(P(q, g.lineThickness)))
            ...
            for (s = !1, l = 0; l < r.length; l++)
              if (
                ...
                if ("number" !== typeof r[l].y)
                  ...
                  l < r.length - 1 &&
                    (k !== (r[l].lineColor || C) ||
                      q !== (r[l].lineDashType || g.lineDashType)) &&
                    ((k = r[l].lineColor || C),
    ...
    l.prototype.renderColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (r = 0; r < a.dataSeriesIndexes.length; r++) {
          ...
          if (0 < C.length)
            for (
              var k = 5 < q && h.bevelEnabled ? !0 : !1, f = 0;
              f < C.length;
              f++
            )
              if (
        ...
        for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
          ...
          if (0 < u.length) {
            ...
            for (g = 0; g < u.length; g++)
              if (
                ((b = u[g].x.getTime ? u[g].x.getTime() : u[g].x),
                !(
                ...
                var z =
                    (r - (a.plotType.plotUnits.length * h) / 2 + a.index * h) <<
                    0,
                  J = (z + h) << 0,
                  y;
                if (
                  ...
                  ((q = a.axisY.convertValueToPixel(u[g].y)), 0 <= u[g].y)
                ) {
    ...
    l.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
          ...
          if (0 < u.length)
            for (
              var s = 5 < h && l.bevelEnabled ? !0 : !1, g = 0;
              g < u.length;
              g++
            )
              if (
          ...
          if (0 < u.length) {
            ...
            for (g = 0; g < u.length; g++)
              if (
                ...
                var z =
                    (q - (a.plotType.plotUnits.length * h) / 2 + a.index * h) <<
                    0,
                  J = (z + h) << 0,
                  y;
                if (
                  ...
                  ((r = a.axisY.convertValueToPixel(u[g].y)), 0 <= u[g].y)
                ) {
                  var B = f[b] ? f[b] : 0;
                  y = p + B;
                  r += B;
    ...
    l.prototype.renderArea = function (a) {
      ...
      function b() {
        y &&
          ...
          f.fill(),
          (f.globalAlpha = 1),
          t && (n.lineTo(l, J), n.lineTo(y.x, J), n.closePath(), n.fill()),
          f.beginPath(),
          f.moveTo(l, u),
          n.beginPath(),
          n.moveTo(l, u),
              ...
              if (
                ...
                !(
                  ...
                  (s > a.axisX.dataInfo.viewPortMax &&
                    (!h.connectNullData || !ha))
                ))
              )
                if ("number" !== typeof C[k].y)
                  h.connectNullData || ha || d || b(), (ha = !0);
                else {
                  ...
                  k < C.length - 1 &&
                    (w !== (C[k].lineColor || v) ||
                      c !== (C[k].lineDashType || h.lineDashType)) &&
                    (b(),
                    (w = C[k].lineColor || v),
                    (f.strokeStyle = w),
                    f.setLineDash &&
                      (C[k].lineDashType
                        ? ((c = C[k].lineDashType),
                          f.setLineDash(P(c, h.lineThickness)))
                        : ((c = h.lineDashType), f.setLineDash(O))));
                  ...
                  0 !== C[k].markerSize &&
                    (0 < C[k].markerSize || 0 < h.markerSize) &&
                    ((s = h.getMarkerProperties(k, l, u, f)),
                    A.push(s),
                    (Z = R(Z)),
                    t &&
                      A.push({
        ...
        for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
          ...
          if (0 < q.length) {
            ...
            for (C = !1; p < q.length; p++)
              if (
                ((h = q[p].x.getTime ? q[p].x.getTime() : q[p].x),
                !(
                ...
                if ("number" !== typeof q[p].y)
                  ...
                  p < q.length - 1 &&
                    ...
                    b.setLineDash &&
                      (q[p].lineDashType
                        ? ((B = q[p].lineDashType),
                          (s[s.length - 1].newLineDashArray = P(
                            B,
                            r.lineThickness
                          )))
                        : ((B = r.lineDashType),
              ...
              if (
                ...
                "number" !== typeof C[k].y
                  ...
                  : ((l = a.axisX.convertValueToPixel(s)),
                    ...
                    k < C.length - 1 &&
                      (w !== (C[k].lineColor || v) ||
                        L !== (C[k].lineDashType || h.lineDashType)) &&
                      (b(),
                      (w = C[k].lineColor || v),
                      (f.strokeStyle = w),
                      f.setLineDash &&
                        (C[k].lineDashType
                          ? ((L = C[k].lineDashType),
                            f.setLineDash(P(L, h.lineThickness)))
                          : ((L = h.lineDashType), f.setLineDash(D)))),
                    (s = h.dataPointIds[k]),
                    ...
                    0 !== C[k].markerSize &&
                      (0 < C[k].markerSize || 0 < h.markerSize) &&
                      ((Z = h.getMarkerProperties(k, l, u, f)),
                      A.push(Z),
                      (s = R(s)),
                      t &&
                        A.push({
                ...
                if ("number" !== typeof ia.y)
                  ...
                  p < v.length - 1 &&
                    ...
                    b.setLineDash &&
                      (v[p].lineDashType
                        ? ((z = v[p].lineDashType),
                          b.setLineDash(P(z, B.lineThickness)))
                  ...
                  0 <= B.dataPointIndexes[f] &&
                    0 !== ia.markerSize &&
                    (0 < ia.markerSize || 0 < B.markerSize) &&
                    ((na = B.getMarkerProperties(
            ...
            for (var Z = !0, p = 0; p < r.length; p++) {
              ...
              if (
                ...
                if ("number" !== typeof ia.y)
                  ...
                  p < w.length - 1 &&
                    (L !== (w[p].lineColor || D) ||
                      u !== (w[p].lineDashType || B.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(h, l),
                    g.push({ x: h, y: x - ca }),
                    ...
                    b.setLineDash &&
                      (w[p].lineDashType
                        ? ((u = w[p].lineDashType),
                          b.setLineDash(P(u, B.lineThickness)))
                  ...
                  0 <= B.dataPointIndexes[f] &&
                    0 !== ia.markerSize &&
                    (0 < ia.markerSize || 0 < B.markerSize) &&
                    ((ca = B.getMarkerProperties(p, h, l, b)),
                    m.push(ca),
                    (f = R(F)),
                    t &&
                      m.push({
        ...
        for (var ga = 0; ga < a.dataSeriesIndexes.length; ga++) {
          ...
          if (0 < x.length)
            for (
              ...
              if (
                (x[m].getTime ? (h = x[m].x.getTime()) : (h = x[m].x),
                !(
                  h < a.axisX.dataInfo.viewPortMin ||
                  h > a.axisX.dataInfo.viewPortMax
                ) &&
    ...
    l.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var ga = !1, ga = !!a.axisY.reversed, aa = 0;
          ...
          if (0 < z.length)
            for (
              ...
              if (
                (z[n].getTime ? (h = z[n].x.getTime()) : (h = z[n].x),
                !(
                  h < a.axisX.dataInfo.viewPortMin ||
                  h > a.axisX.dataInfo.viewPortMax
                ) &&
    ...
    l.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
          ...
          if (0 < h.length)
            for (
              var l = 5 < g && p.bevelEnabled ? !0 : !1, f = 0;
              f < h.length;
              f++
            )
              if (
                (h[f].getTime ? (k = h[f].x.getTime()) : (k = h[f].x),
                !(
                ...
                var ga = a.axisX.reversed
                    ? (b +
                        (a.plotType.totalDataSeries * g) / 2 -
                        (a.previousDataSeriesCount + r) * g) <<
                      0
                    : (b -
                        (a.plotType.totalDataSeries * g) / 2 +
                        (a.previousDataSeriesCount + r) * g) <<
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var aa = 0, u = 0; u < this.data.length; u++)
          !this.data[u].type.match(/(bar|column)/gi) ||
            !this.data[u].visible ||
            (this.data[u].type.match(/(stacked)/gi) && aa) ||
            aa++;
        for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
          var z = a.dataSeriesIndexes[x],
            ...
            D = 0;
          if (B)
            for (e = v._linkedSeries.id, u = 0; u < e; u++)
              !this.data[u].type.match(/(bar|column)/gi) ||
                !this.data[u].visible ||
                (this.data[u].type.match(/(stacked)/gi) && D) ||
                (this.data[u].type.match(/(range)/gi) && (f = !0), D++);
          e = this.options.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.options.dataPointWidth
            ? this.dataPointWidth
          ...
          m = this.options.dataPointMaxWidth
            ...
            ? Math.min(
                0.15 * this.height,
                0.9 * (this.plotArea.height / (B ? aa : 1))
              ) << 0
            : 0.3 * this.width;
          f &&
            (m = this.options.dataPointMaxWidth
          ...
          if (0 < y.length)
            for (var E = v._colorSet, m = 0; m < y.length; m++) {
              ...
              O.thickness =
                "number" === typeof O.thickness
                  ? 0 > O.thickness
                    ? 0
                    : Math.round(O.thickness)
                  : 2;
              ...
              if (
                ...
                b
                  ? ((p = a.axisX.reversed
                      ? (g + ((B ? aa : 1) * u) / 2 - (B ? D - 1 : 0) * u) << 0
                      : (g - ((B ? aa : 1) * u) / 2 + (B ? D - 1 : 0) * u) <<
                        0),
                    (h = a.axisX.reversed ? (p - u) << 0 : (p + u) << 0))
                  : ((r = a.axisX.reversed
                      ? (k + ((B ? aa : 1) * u) / 2 - (B ? D - 1 : 0) * u) << 0
                      : (k - ((B ? aa : 1) * u) / 2 + (B ? D - 1 : 0) * u) <<
                        0),
        ...
        for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
          ...
          if (0 < l.length) {
            ...
            for (f = 0; f < l.length; f++)
              if (
                (l[f].getTime ? (g = l[f].x.getTime()) : (g = l[f].x),
                !(
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < q.length) {
            ...
            for (var L = !0; h < q.length; h++)
              if (
                ((u = q[h].x.getTime ? q[h].x.getTime() : q[h].x),
                !(
                  u < a.axisX.dataInfo.viewPortMin ||
                  (u > a.axisX.dataInfo.viewPortMax &&
                    (!r.connectNullData || !L))
                ...
                if (
                  null !== q[h].y &&
                  q[h].y.length &&
                  "number" === typeof q[h].y[0] &&
                  "number" === typeof q[h].y[1]
                ) {
                  ...
                  h < q.length - 1 &&
                    (y !== (q[h].lineColor || w) ||
                      B !== (q[h].lineDashType || r.lineDashType)) &&
                    (d(),
                    (y = q[h].lineColor || w),
                    ...
                    b.setLineDash &&
                      (q[h].lineDashType
                        ? ((B = q[h].lineDashType),
                          (k[k.length - 1].newLineDashArray = P(
                            B,
                            r.lineThickness
                          )),
                  ...
                  if (
                    0 !== q[h].markerSize &&
                    (0 < q[h].markerSize || 0 < r.markerSize)
                  ) {
                  ...
                  if (
                    ...
                    this._indexLabels.push({
                      ...
                      point: { x: l, y: s },
                      direction:
                        q[h].y[0] > q[h].y[1] === a.axisY.reversed ? -1 : 1,
                      color: z,
                    }),
                      this._indexLabels.push({
                        chartType: "rangeArea",
            ...
            for (h = !1; q < r.length; q++)
              if (
                ...
                if (
                  ...
                  q < r.length - 1 &&
                    (z !== (r[q].lineColor || x) ||
                      w !== (r[q].lineDashType || g.lineDashType)) &&
                    ((z = r[q].lineColor || x),
                  ...
                  if (
                    0 !== r[q].markerSize &&
                    (0 < r[q].markerSize || 0 < g.markerSize)
                  ) {
            ...
            for (
              ...
              if (
                ...
                0 < n &&
                  y &&
                  (!w || s.connectNullData) &&
                  (w && c.setLineDash && c.setLineDash(P(D, u)),
                  c.beginPath(),
                  c.moveTo(y, B - x),
                  c.lineTo(L, O - x),
                  0 < u && c.stroke(),
    ...
    l.prototype.renderPie = function (a) {
        ...
        if (g && r) {
          for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < r.length; e++) {
            ...
            q = f.indexLabelFormatter
              ...
              : f.indexLabel
              ? k.replaceKeywordsWithValue(f.indexLabel, f, g, e)
              : g.indexLabelFormatter
              ? g.indexLabelFormatter(l)
              : g.indexLabel
              ? k.replaceKeywordsWithValue(g.indexLabel, f, g, e)
              : f.label
              ? f.label
              : "";
            ...
            m.indexLabelLineColor = f.indexLabelLineColor
              ...
              : g.options.indexLabelLineColor
              ? g.options.indexLabelLineColor
              : f.color
              ? f.color
              : g._colorSet[e % g._colorSet.length];
            ...
            m.indexLabelBackgroundColor = f.indexLabelBackgroundColor
              ...
              : g.options.indexLabelBackgroundColor
              ? g.options.indexLabelBackgroundColor
      ...
      function c(a) {
        ...
        for (b = 0; b < r.length; b++) {
          ...
          if (d > c) {
            ...
            if (r[b].exploded) {
              if (
                1e-9 < Math.abs(h[b].center.x - (z.x + e)) ||
                1e-9 < Math.abs(h[b].center.y - (z.y + f))
              )
                (h[b].center.x = z.x + e * a),
                  (h[b].center.y = z.y + f * a),
                  (m = !0);
            } else if (
              0 < Math.abs(h[b].center.x - z.x) ||
              0 < Math.abs(h[b].center.y - z.y)
            )
            ...
            Y(
              ...
              h[b].center,
              h[b].radius,
              r[b].color ? r[b].color : g._colorSet[b % g._colorSet.length],
              g.type,
              c,
              d,
              g.fillOpacity,
          ...
          (c = h[b]),
            c.indexLabelText &&
              ...
              "inside" !== c.indexLabelPlacement &&
                ...
                a.setLineDash &&
                  a.setLineDash(
                    P(c.indexLabelLineDashType, c.indexLabelLineThickness)
                  ),
                a.beginPath(),
                a.moveTo(d, e),
        ...
        if (0 <= a && a < r.length) {
          ...
          for (n = 1; n < r.length; n++)
            if (
              ...
              (0 > b(h[m], h[a]) ||
                ("right" === h[a].hemisphere
                  ? h[m].indexLabelTextBlock.y <= h[a].indexLabelTextBlock.y
                  : h[m].indexLabelTextBlock.y >= h[a].indexLabelTextBlock.y))
            )
              break;
            else m = null;
            ...
            ? ((n = "right" === k.hemisphere ? q : p),
              ...
              null !== n &&
                ...
                (c =
                  k.indexLabelTextBlock.y -
                  k.indexLabelTextBlock.height / 2 -
                  (h[n].indexLabelTextBlock.y +
                    h[n].indexLabelTextBlock.height / 2)),
                c - q < l &&
                  ((m = -q),
                  (n = f(n, m, d + 1)),
              ...
              if (null !== y) {
                ...
                if (0 > w) {
                  for (var J = (s = 0), I = 0; I < r.length; I++)
                    I !== a &&
                      h[I].hemisphere === n.hemisphere &&
                      (h[I].indexLabelTextBlock.y < n.indexLabelTextBlock.y
                        ? s++
                        : J++);
                  s = (w / (s + J || 1)) * J;
                  var J = -1 * (w - s),
                  ...
                  "right" === n.hemisphere
                    ? ((I = f(a, s)),
                      (J = -1 * (w - I)),
                      (G = f(y, J)),
                      +G.toFixed(x) < +J.toFixed(x) &&
                        +I.toFixed(x) <= +s.toFixed(x) &&
                        f(a, -(J - G)))
                    : ((I = f(y, s)),
                      (J = -1 * (w - I)),
                      (G = f(a, J)),
              ...
              if (((f = !1), (u = h[g]), u.indexLabelText)) {
                ...
                if (null !== n) {
                  ...
                  k
                    ? (0 > a && (a = g),
                      n !== a && ((c = n), (d += -w)),
                      0 === g % Math.max(r.length / 10, 3) && (f = !0))
                    : (f = !0);
                  f &&
                    0 < d &&
                    0 <= a &&
      ...
      var k = this;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var g = this.data[a.dataSeriesIndexes[0]],
          r = g.dataPoints,
          q = 10,
          p = this.plotArea,
          h = g.dataPointEOs,
        ...
        if (0 !== w) {
          a =
            ...
            ("undefined" !== typeof g.indexLabel &&
              null !== g.indexLabel &&
              0 < g.indexLabel.toString().length);
          var B =
          ...
          var D =
            "undefined" !== typeof g.innerRadius && null !== g.innerRadius
              ? Ra(g.innerRadius, B)
              : 0.7 * B;
          g.radius = B;
          ...
          this._animator.animate(
            ...
            function (a) {
              ...
              for (b = 0; b < r.length; b++) {
                ...
                var f = r[b].color
                  ? r[b].color
                  : g._colorSet[b % g._colorSet.length];
                d > c &&
                  Y(
                    k.plotArea.ctx,
                    h[b].center,
    ...
    l.prototype.renderFunnel = function (a) {
      ...
      function c() {
        ...
        if (0 === h) return -1;
        for (
          var n = (d[0] = 0), m = 0, k, r, b = b - a, n = !1, g = 0;
          g < x.length;
          g++
        )
        ...
        if (e)
          for (m = H.length - 1; 0 <= m; m--)
            (a = Q[m]),
              ...
              u.reversed
                ? (H[m].textBlock.y + H[m].height > T + D &&
                    (H[m].textBlock.y = T + D - H[m].height),
                  H[m].textBlock.y < sa - D && (H[m].textBlock.y = sa - D))
                : (H[m].textBlock.y < T - D && (H[m].textBlock.y = T - D),
          ...
          for (var e = 0; e < Q.length; e++)
            0 == H[e].textBlock.text.length
              ...
              : ((a = Q[e]),
                ...
                u.reversed
                  ? (H[e].textBlock.y + H[e].height > T + D &&
                      (H[e].textBlock.y = T + D - H[e].height),
                    H[e].textBlock.y < sa - D && (H[e].textBlock.y = sa - D))
                  : (H[e].textBlock.y < T - D && (H[e].textBlock.y = T - D),
          ...
          for (var m, n = 1; n < g; n++) {
            ...
            for (var r = H.length - 1; 0 <= r; r--)
              !H[r].isDirty &&
                ...
                ((m = p(r)),
                !(m >= H.length - 1) &&
                  H[r].textBlock.y + H[r].height + ea > H[m].textBlock.y &&
                  (H[r].textBlock.y =
      ...
      function m(a, b) {
        return (
          (b < Q.length ? H[b].textBlock.y : u.reversed ? T + D : sa + D) -
          (0 > a
            ? u.reversed
              ? sa - D
              : T - D
        ...
        for (var b, c, d, e, f = 0; f < Q.length; f++)
          (e = 1 === H[f].lineThickness % 2 ? 0.5 : 0),
            ...
            H[f].isDirty ||
              ...
              a.setLineDash &&
                a.setLineDash(P(H[f].lineDashType, H[f].lineThickness)),
              a.beginPath(),
              a.moveTo(b, c),
              a.lineTo(d, e),
              a.stroke());
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var u = this.data[a.dataSeriesIndexes[0]],
            ...
            B = 0,
            E = z.height - 2 * D,
            G = Math.min(z.width - 2 * y, 2.8 * z.height),
            L = !1,
            O = 0;
          O < x.length;
          O++
          ...
          if (
            (!L &&
              "undefined" !== typeof x[O].indexLabel &&
              null !== x[O].indexLabel &&
              0 < x[O].indexLabel.toString().length &&
              (L = !0),
            !L &&
              "undefined" !== typeof x[O].label &&
              null !== x[O].label &&
              0 < x[O].label.toString().length &&
              (L = !0),
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== x.length) {
          ...
          var V = (30 * (M - a)) / 100;
          "funnel" === u.type
            ? ((ca = s(u.options.neckHeight) ? 0.35 * E : u.neckHeight),
              ...
              F > a ? (F = a - 0.5) : 0 >= F && (F = 0))
            : "pyramid" === u.type &&
              ((F = ca = 0), (u.reversed = u.reversed ? !1 : !0));
          var y = O + a / 2,
            W = O,
            $ = O + a,
            T = u.reversed ? S : Z,
          ...
          if (-1 !== O) {
            if (u.reversed)
              for (G.push(U), F = O.length - 1; 0 < F; F--)
                (U += O[F]), G.push(U);
            else for (F = 0; F < O.length; F++) (U += O[F]), G.push(U);
            if (u.reversed)
              for (F = 0; F < O.length; F++)
                G[F] < xa
                  ? (a.push(K), y.push(X), (da = F))
                  : (a.push((G[F] - T + ba * W) / ba),
                    y.push((G[F] - T + fa * $) / fa));
            else
              for (F = 0; F < O.length; F++)
                G[F] < xa
            ...
            for (F = 0; F < O.length - 1; F++)
              (U = u.reversed
                ? x[x.length - 1 - F].color
                  ? x[x.length - 1 - F].color
                  : u._colorSet[(x.length - 1 - F) % u._colorSet.length]
                : x[F].color
                ? x[F].color
            ...
            for (F = 0; F < x.length; F++)
              x[F].exploded &&
                ((O = !0), u.reversed ? Y.push(x.length - 1 - F) : Y.push(F));
            ...
            if (
              ...
              for (F = 0; F < Q.length; F++)
                (Q[F].x1 += B),
                  ...
                  (Q[F].x3 += B),
                  (Q[F].x4 += B),
                  Q[F].x5 && ((Q[F].x5 += B), (Q[F].x6 += B)),
                  (H[F].textBlock.x += B);
            }
            for (F = 0; F < Q.length; F++)
              (B = Q[F]), qa(R, B, u.fillOpacity), ja.push(B.y1);
            v(R);
            L &&
              u.visible &&
              ("inside" === u.indexLabelPlacement || w.animationEnabled || r(R),
            ...
            var p = (q.legendMarkerType = q.legendMarkerType
                ...
                ? "error" === q.type && q._linkedSeries
                  ? q._linkedSeries.legendMarkerType
                    ? q._linkedSeries.legendMarkerType
                    : G.getDefaultLegendMarker(q._linkedSeries.type)
                  : G.getDefaultLegendMarker(q.type)
                : q.markerType),
              h = q.legendText
                ? q.legendText
            ...
            if ("horizontal" === this.orientation) {
              ...
              (p.textBlock = new la(this.ctx, {
                ...
                this.height < n - this.lineHeight
                  ? ((q = { items: [], width: 0 }), g.push(q))
                  : ((q = g[x]), (x = (x + 1) % g.length)),
    ...
    D.setLayout = function (a, d, c, b, e, f) {
      ...
      for (h = 0; h < p.length; h++)
        if (p[h] && p[h].scaleBreaks && p[h].scaleBreaks._appliedBreaks.length)
          for (
            var t = p[h].scaleBreaks._appliedBreaks, v = 0;
            v < t.length && !(t[v].startValue > p[h].viewportMaximum);
            v++
          )
            t[v].endValue < p[h].viewportMinimum ||
              (s(p[h].scaleBreaks.firstBreakIndex) &&
                (p[h].scaleBreaks.firstBreakIndex = v),
              t[v].startValue >= p[h].viewPortMinimum &&
                (p[h].scaleBreaks.lastBreakIndex = v));
      for (
        var w = (v = 0),
          u = 0,
          x = 0,
        ...
        p[h] &&
          p[h].title &&
          (p[h]._titleTextBlock = new la(p[h].ctx, {
            text: p[h].title,
            horizontalAlign: "center",
        ...
        if (p[h].title)
          switch (p[h]._position) {
            case "left":
              ...
              p[h]._titleTextBlock.maxHeight = p[h].titleWrap
                ? 0.8 * f.width
                : 1.5 * p[h].titleFontSize;
      ...
      if ("normal" === e) {
        for (
          ...
          k = Math.round(
            f.x2 - ba - $ > l.width - q ? l.width - q : f.x2 - ba - $
          );
          if (a && 0 < a.length)
            for (x = [], h = U = 0; h < a.length; h++)
              ...
              a[h] &&
                ...
                a[h]._labels &&
                  ...
                  (w =
                    ...
                    (g.textBlock.height - m.textBlock.fontSize / 2) *
                ...
                !a[h] ||
                  ...
                  0 < a[h].labelAngle
                    ? E + u > k &&
                      (m += 0 < a[h].labelAngle ? E + u - k - ba : 0)
                    : 0 > a[h].labelAngle
                    ? B - w < n &&
                      B - w < a[h].viewportMinimum &&
                      (G =
                        n -
                        (K +
                          a[h].tickLength +
                ...
                d[h]._labels &&
                  ...
                  (u =
                    ...
                    (m.textBlock.height - m.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(m.textBlock.angle)))),
                l.panEnabled
                  ? (X = s(l.sessionVariables.axisX2.height)
              ...
              b[h] &&
                ...
                (K =
                  b[h]._labels && 0 < b[h]._labels.length
                    ...
                    : 0),
                (m = Math.round(
                  f.y1 + X + Y < Math.max(K, q) ? Math.max(K, q) : f.y1 + X + Y
                )),
                (K =
                  0 < a.length
                    ? 0
              ...
              a[h] &&
                ...
                a[h]._labels &&
                  ...
                  (E = a[h].logarithmic
                    ...
                    : (0 < n
                        ? n * Math.abs(a[h].conversionParameters.pixelPerUnit)
                        : 0) + a[h].lineCoordinates.x1)));
          if (d && 0 < d.length)
            for (h = 0; h < d.length; h++)
              d[h].calculateValueToPixelConversionParameters(),
                ...
                d[h]._labels &&
                  ...
                  (E = d[h].logarithmic
                    ...
                    : (0 < n
                        ? n * Math.abs(d[h].conversionParameters.pixelPerUnit)
                        : 0) + d[h].lineCoordinates.x1));
          for (h = 0; h < p.length; h++)
            "axisY" === p[h].type &&
              (p[h].calculateValueToPixelConversionParameters(),
        ...
        for (P = []; 4 > v; ) {
          ...
          if (c && 0 < c.length)
            for (h = 0; h < c.length; h++)
              (c[h].lineCoordinates = {}),
                ...
                (k = Math.round(
                  f.x2 - U - Y > l.width - 10 ? l.width - 10 : f.x2 - U - Y
                )),
                c[h].labelAutoFit &&
                  !s(x) &&
                  (0 < !a.length &&
          ...
          if (l.panEnabled)
            for (h = 0; h < c.length; h++)
              q[h] = s(l.sessionVariables.axisY.height)
            ...
            for (h = 0; h < a.length; h++) {
              ...
              if (b && 0 < b.length)
                for (K = 0; K < b.length; K++)
                  b[K] &&
                    b[K].labelAutoFit &&
                    ((k = b[K].lineCoordinates.x1), (n = k - W));
              a[h].lineCoordinates = {
                x1: k - R,
                y1: m,
                x2: k - R,
    ...
    D.prototype.renderStripLinesOfThicknessType = function (a) {
      if (this.stripLines && 0 < this.stripLines.length && a) {
        for (
          ...
          g._thicknessType === a &&
            (("pixel" === a &&
              (g.value < this.viewportMinimum ||
                g.value > this.viewportMaximum ||
                s(g.value) ||
                isNaN(this.range))) ||
              m.push(g));
        }
            ...
            if ("outside" === c.stripLine.labelPlacement)
              if (
                (g &&
                  ...
                  "pixel" === g._thicknessType &&
                    (this.ctx.lineWidth = g.thickness)),
    ...
    D.prototype.renderGrid = function () {
      if (this.gridThickness && 0 < this.gridThickness) {
        ...
        a.setLineDash &&
          a.setLineDash(P(this.gridDashType, this.gridThickness));
        if ("bottom" === this._position || "top" === this._position)
          for (b = 0; b < this._labels.length; b++)
    ...
    D.prototype.renderAxisLine = function () {
      ...
      if ("bottom" === this._position || "top" === this._position) {
        if (this.lineThickness) {
          ...
          d.setLineDash &&
            d.setLineDash(P(this.lineDashType, this.lineThickness));
          var k =
            ...
            (b / 1 <= a
              ...
              : ((this.interval =
                  b / (1 * S.yearDuration) <= a
                    ...
                    ? 4
                    : Math.floor(
                        D.getNiceNumber(b / (a - 1), !0) / S.yearDuration
                      )),
      ...
      if (
        ...
        if (
          ...
          if (
            ...
            r = (k - l) / a / 2;
            for (p = 0; p < r; p++)
              this.ctx.lineTo(l, g), (g += 2 * f * a), (l += 2 * a), (f *= -1);
            this.ctx.lineTo(l, g);
            g += m - e;
            for (p = 0; p < r + 1; p++)
              this.ctx.lineTo(l, g), (g += 2 * f * a), (l -= 2 * a), (f *= -1);
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          if (
            ...
            g.x + g.width > this.chart.bounds.x2
              ? (g.x = this.chart.bounds.x2 - g.width)
              : g.x < this.chart.bounds.x1 && (g.x = this.chart.bounds.x1);
            g.y = this.parent.lineCoordinates.y2 + g.fontSize / 2 + 2;
            g.y + g.height > this.chart.bounds.y2
              ? (g.y = this.chart.bounds.y2 - g.height)
              : g.y < this.chart.bounds.y1 && (g.y = this.chart.bounds.y1);
          } else if (
            "left" === this.parent._position ||
            "right" === this.parent._position
          ) {
            ...
            g.y - g.fontSize / 2 < this.chart.bounds.y1
              ? (g.y = this.chart.bounds.y1 + g.fontSize / 2 + 2)
              : g.y + g.measureText().height - g.fontSize / 2 >
                ...
                (g.y =
                  ...
                  g.fontSize / 2);
            "left" === this.parent._position
              ? (g.x = this.parent.lineCoordinates.x2 - g.measureText().width)
              : "right" === this.parent._position &&
          ...
          "bottom" === this.parent._position
            ...
            : "top" === this.parent._position &&
              (g.y =
                this.parent.lineCoordinates.y1 - g.height + g.fontSize / 2 + 2);
        } else if (
          "left" === this.parent._position ||
          "right" === this.parent._position
        ) {
          ...
          g.y - g.fontSize / 2 < this.chart.bounds.y1
            ...
            : g.y + g.measureText().height - g.fontSize / 2 >
                this.chart.bounds.y2 &&
              (g.y =
                this.chart.bounds.y2 - g.measureText().height + g.fontSize / 2);
          "left" === this.parent._position
            ? (g.x = this.parent.lineCoordinates.x2 - g.measureText().width)
            : "right" === this.parent._position &&
              (g.x = this.parent.lineCoordinates.x2);
        ...
        if (
          ...
          "top" === this.parent._position &&
            g.y - g.fontSize / 2 < this.chart.bounds.y1 &&
            (g.y = this.chart.bounds.y1 + g.fontSize / 2),
            "bottom" === this.parent._position &&
              this.parent.lineCoordinates.y2 -
                g.fontSize / 2 +
                g.measureText().height >
                this.chart.bounds.y2 &&
              (g.y = this.chart.bounds.y2 - g.height + g.fontSize / 2 + 2),
            b >= this.parent.convertValueToPixel(this.parent.viewportMinimum) &&
              ...
              p.restore(),
              !s(g.text) &&
                ("number" === typeof g.text.valueOf() || 0 < g.text.length) &&
                g.render(!0));
        if (
          "left" === this.parent._position ||
          "right" === this.parent._position
          ...
          "left" === this.parent._position &&
            g.x < this.chart.bounds.x1 &&
            (g.x = this.chart.bounds.x1),
            "right" === this.parent._position &&
              g.x + g.measureText().width > this.chart.bounds.x2 &&
              (g.x = this.chart.bounds.x2 - g.measureText().width),
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement)
            ...
            g.y - g.fontSize / 2 < this.chart.bounds.y1
              ...
              : g.y + g.measureText().height - g.fontSize / 2 >
                ...
                (g.y =
                  ...
                  g.fontSize / 2);
            "left" === this.parent._position
              ? (g.x = this.parent.lineCoordinates.x1 - g.measureText().width)
              : "right" === this.parent._position &&
                (g.x = this.parent.lineCoordinates.x2);
          } else {
            if (
          ...
          (g.text = this.labelFormatter
            ...
            "left" === this.parent._position
              ...
              : "right" === this.parent._position &&
                (g.x = this.parent.lineCoordinates.x2);
        "left" === this.parent._position && g.x < this.chart.bounds.x1
          ? (g.x = this.chart.bounds.x1)
          : "right" === this.parent._position &&
            g.x + g.measureText().width > this.chart.bounds.x2
          ? (g.x = this.chart.bounds.x2 - g.measureText().width)
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (
            ...
            if (this.chart.axisX)
              for (var l = 0; l < this.chart.axisX.length; l++) {
                for (
                  ...
                  (g = this.chart.axisX[l].dataSeries[b].getDataPointAtX(
                    k,
                    c
                  )) &&
                    0 <= g.index &&
                    ((g.dataSeries = this.chart.axisX[l].dataSeries[b]),
            ...
            if (this.chart.axisX2)
              for (l = 0; l < this.chart.axisX2.length; l++) {
                ...
                for (b = 0; b < this.chart.axisX2[l].dataSeries.length; b++)
                  (g = this.chart.axisX2[l].dataSeries[b].getDataPointAtX(
                    k,
                    c
                  )) &&
                    0 <= g.index &&
                    ((g.dataSeries = this.chart.axisX2[l].dataSeries[b]),
                    null !== g.dataPoint.y && m.push(g));
                g = null;
              }
          } else {
          ...
          if ((g = this.chart.getDataPointAtXY(a, d, c)))
            ...
            if (
              ((g = Ya(a, d, this.chart._eventManager.ghostCtx)),
              0 < g &&
                "undefined" !== typeof this.chart._eventManager.objectMap[g])
            ) {
              ...
              this.currentDataPointIndex =
                0 <= g.dataPointIndex ? g.dataPointIndex : -1;
              ...
              if (g.dataSeries.axisY)
                if (0 < g.dataPoint.y.length) {
                  for (b = c = 0; b < g.dataPoint.y.length; b++)
                    g.dataPoint.y[b] < g.dataSeries.axisY.viewportMinimum
                      ? c--
                      : g.dataPoint.y[b] > g.dataSeries.axisY.viewportMaximum &&
                        c++;
                  c < g.dataPoint.y.length &&
                    c > -g.dataPoint.y.length &&
                    f.push(g);
                } else
                  "column" === e.type || "bar" === e.type
                    ? 0 > g.dataPoint.y
                      ? 0 > g.dataSeries.axisY.viewportMinimum &&
                        g.dataSeries.axisY.viewportMaximum >= g.dataPoint.y &&
                        f.push(g)
                      : g.dataSeries.axisY.viewportMinimum <= g.dataPoint.y &&
                        0 <= g.dataSeries.axisY.viewportMaximum &&
                        f.push(g)
                    : "bubble" === e.type
                    ? ((c =
                        this.chart._eventManager.objectMap[
                          e.dataPointIds[g.index]
                        ].size / 2),
                      g.dataPoint.y >= g.dataSeries.axisY.viewportMinimum - c &&
                        g.dataPoint.y <=
                          g.dataSeries.axisY.viewportMaximum + c &&
                        f.push(g))
                    : "waterfall" === e.type
                    ? ((c = 0),
                      g.cumulativeSumYStartValue <
                      g.dataSeries.axisY.viewportMinimum
                        ? c--
                        : g.cumulativeSumYStartValue >
                            g.dataSeries.axisY.viewportMaximum && c++,
                      g.cumulativeSum < g.dataSeries.axisY.viewportMinimum
                        ? c--
                        : g.cumulativeSum >
                            g.dataSeries.axisY.viewportMaximum && c++,
                      2 > c && -2 < c && f.push(g))
                    : (0 <= g.dataSeries.type.indexOf("100") ||
                        "stackedColumn" === e.type ||
                        "stackedBar" === e.type ||
                        (g.dataPoint.y >= g.dataSeries.axisY.viewportMinimum &&
                          g.dataPoint.y <=
                            g.dataSeries.axisY.viewportMaximum)) &&
                      f.push(g);
              else f.push(g);
          }
        }
